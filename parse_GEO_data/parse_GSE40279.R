...
show(gse)
dim(pData(gse[[1]])) #656 sample x 41col
head(pData(gse[[1]]))
...
# Download 'GSE40279_series_matrix.txt.gz' in Hannum et al. 
# data from https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE40279

...
**The 5 genotypes can be grouped by tradeoff between longevity and fecundity**

- wt: wildtype

- mode.1: 19/74, 74/211, 211/19 are ‘mode.1’ transheterozygous genotypes using three mutation alleles (E19, 74, 211). These have longevity but reduced growth and reproduction along with low pAkt/insulin resistance. These genotypes may extend lifespan by reducing costs of reproduction.

- mode.2 : wt/353 is the ‘mode.2’ genotype (longevity but normal growth, reproduction, pAkt/insulin sensitivity). This genotype may provide ‘longevity assurance’
...
```{r fig.width=16}
#mz.out.file='fecundity_candidate.mz.txt'
#mz.out.file='insulin_candidate.mz.txt'
mz.out.file='tradeoff_candidate.mz.txt'
...
data.table::fwrite(df.sig.out.adj2,mz.out.file)
#data.table::fwrite(df.sig.out.adj2,'fecundity_candidate.mz.txt')
df.sig.out.adj2
```
